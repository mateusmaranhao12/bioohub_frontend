    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="row w-75">
            ...
            <div v-if="etapa === 1"
                ...
                class="cadastro col-md-6">
                <h2 class="animate__animated animate__zoomIn h2-cadastro mb-3">First, claim your unique link</h2>
                <h5 class=" animate__animated animate__zoomIn h5-cadastro">The good ones are still available!</h5>
